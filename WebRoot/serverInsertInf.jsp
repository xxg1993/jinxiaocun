...
%>
      ...
      <font color="green" align="center">修改随访记录</font><br>

    	<form action="ServerAction?method=updateUAfterSale" method="post">
    <table align="center" width=50% border="2" cellpadding="10" cellspacing="6" bordercolor="3399FF" >
    	   	<tr>
    	   		<td align="center" rowspan=2 width="80%"><font color=green size=6><b>随访记录</b></font></td>
    	   		<td>姓名：${map.name }<input type="hidden" name="id" size="10" maxlength="10" value="${map.id}"></td>
    	   	</tr>
    	   	<tr>
			 ...
			 <tr>
				<input type="hidden" name="nowtime" value="<%=date1 %>">
			</tr>
