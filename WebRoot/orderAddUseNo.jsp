...
<html>
  <head>
    ...
    <title>My JSP 'orderAddUseNo.jsp' starting page</title>
  ...
  <body align="center">&nbsp; 
   ...
   <%
    ...
    用户<%=session.getAttribute("ordername") %>尚未注册
    <br>
   ...
   <form action="OrderAction?method=addOrderTimeY" method="post">
    <table align="center">
    	...
    	<tr>
    		<td>客户id</td>
    		<td><input type="hidden" name="id" readonly="true" value="未注册"></td>
    	</tr>
    	<tr>
    		<td>客户名字</td><td><input type="text" name="name" value="<%=session.getAttribute("ordername") %>"></td>
    	</tr>
    	<tr>
    		<td>联系方式</td> <td><input type="text" name="phone" size="20"> </td>
    	</tr>
